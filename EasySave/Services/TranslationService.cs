...
namespace EasySave.Services
{
    ...
    public class TranslationService : INotifyPropertyChanged
    {
        ...
        private Dictionary<string, string> InitializeTranslations()
        {
            ...
            translations["en_encryption_key"] = "Encryption Key:";
            ...
            translations["en_settings_encrypt_note"] = "- Encrypt Extensions: List of file extensions (e.g. .pdf, .docx) to encrypt securely.";
            translations["en_settings_key_note"] = "- Encryption Key: Security key shared with CryptoSoft. Changing it here updates the shared file.";
            ...
            translations["fr_encryption_key"] = "Clé de Chiffrement:";
            ...
            translations["fr_settings_encrypt_note"] = "- Extensions à Chiffrer : Liste des extensions (ex: .pdf) à sécuriser via CryptoSoft.";
            translations["fr_settings_key_note"] = "- Clé de Chiffrement : Clé de sécurité partagée. La modifier ici met à jour le fichier commun.";
